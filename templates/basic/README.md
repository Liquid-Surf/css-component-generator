...
When creating your own project you will need to update all the URLs above and replace `template-name-module`
...
[here](https://communitysolidserver.github.io/configuration-generator/v7/?config=https%3A%2F%2Fraw.githubusercontent.com%2FCommunitySolidServer%2Ftemplate-name-component%2Fmain%2Ftemplate-name-file.json).

## template-name-partial.json
Similar to template-name-file.json this configuration defines how the new component is added to a CSS instance.
...
[here](https://communitysolidserver.github.io/configuration-generator/v7/?config=https%3A%2F%2Fraw.githubusercontent.com%2FCommunitySolidServer%2Ftemplate-name-component%2Fmain%2Ftemplate-name-partial.json).
...
### test/config/template-name-memory.json
This is a configuration file that is used to test a server running with our new component.
It is very similar to the `template-name-file.json` from above,
...
### test/unit/TemplateName.test.ts
